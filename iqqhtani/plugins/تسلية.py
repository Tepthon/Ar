...
async def iqvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="- @Tepthon",parse_mode="html")
...
async def gbun(event):
    ...
    if event.reply_to_msg_id:
        ...
        idd = reply_message.sender_id
        if idd == 1260465030:
            await catevent.edit(                "عذرا هذا مبرمج السورس محمد"            )
        else:
