...
IqqhtaniPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/0a370c80ae526bfcb316a.jpg"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/0a370c80ae526bfcb316a.jpg"
...
async def iq(iqqhtanievent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 TO TEPTHON 𓃠"
    Iqqhtani_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/0a370c80ae526bfcb316a.jpg"
...
async def amireallyalive(event):
    ...
    IIqqhtani_ALIVE_TEXT = "❬ lتيبثون العـرب - TEPTHON-Arabe ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"♛︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تيبثون @Tepthon :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث تيبثون انتضر من 5 الى 10 دقائق")
    try:
...
async def variable(var):
    ...
    if exe == "get":
        ...
        await ics.edit(f"**⌔** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت تيبثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
...
( .ايقاف اسم وقتي )
———————×———————
 ♛︙ يوجد شرح مفصل عن الامر هنا : https://t.me/Tepthon/4484
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط القروب يضيفهم بقروبك
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/Tepthon/4483
شرح الأوامر : ( @Tepthon ) .
قناه السورس : ( @Tepthon ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/Tepthon/4704
قناه السورس : ( @Tepthon ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/Tepthon/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/Tepthon/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/Tepthon/4720  ⦒
""")
...
———————×———————
الأمر ⦙ ( .المده )
الشرح  : يضهر لك مدة تشغيل بوت تيبثون لديك
———————×———————
الأمر ⦙ ( .تحميل ملف + الرد ع الملف )
الشرح : يحمل ملفات تيبثون
———————×———————
الأمر ⦙ ( .مسح ملف + الرد ع الملف )
الشرح :  يمسح الملف الي حملته
———————×———————
الأمر ⦙ ( .تحديث )
الشرح :  امر لأعاده التشغيل وتحديث ملفات السورس وتسريع التيبثون
———————×———————
الأمر ⦙ ( .اطفاء مؤقت + عدد الثواني )
الشرح : يقوم بأطفاء التيبثون بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل التيبثون
———————×———————
الأمر ⦙ ( .الاوامر )
...
———————×———————
الأمر ⦙ ( .استخدامي )
الشرح :   يضهر لك كمية استخدامك لتيبثون
———————×———————
الأمر ⦙ ( .تاريخ التنصيب )
...
الشرح : اي شخص يعملك تاك او يراسلك او يرد عليك يرد عليه تيبثون بكليشة انا حاليا غير موجود ويضع له السبب الي نتة وضعته
———×———
...
@check_owner
async def inlineiqqhtani(iqqhtani):
    text = " ℘︙ قـائمـه الاوامـر :**\n ℘︙ قنـاه السـورس :** @Tepthon\n ℘︙ شـرح اوامـر السـورس : @Tepthon**\n ℘︙ شـرح فـارات السـورس : @Tepthon** "
